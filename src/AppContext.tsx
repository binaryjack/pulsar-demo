...
import { createContext, IApplicationRoot, useContext } from '@pulsar-framework/pulsar.dev';
...
export const AppContextProvider = ({
  ...
  Promise.resolve().then(() => {
    const wrapped = <AppContext.Provider value={context}>{children}</AppContext.Provider>;
